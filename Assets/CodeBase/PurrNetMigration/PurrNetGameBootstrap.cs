...
public sealed class PurrNetGameBootstrap : MonoBehaviour
{
    ...
    private void Bootstrap(PurrNetSessionSettings settings)
    {
        ...
        PurrVehicleDamageConfigSync damageConfigSync = GetOrAddComponent<PurrVehicleDamageConfigSync>(predictionManager.gameObject);
        damageConfigSync.Configure(runtimeTemplateCar);
    ...
    private void PrepareRuntimeTemplate(PlayerCar runtimeTemplateCar)
    {
        ...
        GetOrAddComponent<PurrVehicleSimulationBridge>(runtimeTemplateObject);
